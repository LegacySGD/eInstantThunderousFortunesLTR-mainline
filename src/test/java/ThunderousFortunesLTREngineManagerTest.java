...
public class ThunderousFortunesLTREngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ThunderousFortunesLTREngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ThunderousFortunesLTRIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ThunderousFortunesLTRIW/InitOutcome.xml").getDocumentElement();
